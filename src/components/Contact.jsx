...
const links = [
  {
    ...
    href: "https://wa.me/+5521972505271?text=Olá%2C%20gostaria%20de%20saber%20mais%20sobre%20seus%20projetos!",
    icon: (
...
function Contact() {
  ...
  const handleSubmit = () => {
    ...
    window.open(`https://wa.me/+5521972505271?text=${text}`, "_blank");
  };
